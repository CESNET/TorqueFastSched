...
/* Define to track job status via glite LB */
/* #undef HAVE_GLITE_LB */
...
/* Define to 1 if you have the `pbscache' library (-lpbscache). */
#define HAVE_LIBPBSCACHE 1
...
/* Define to 1 if you have the <pbs_cache_api.h> header file. */
#define HAVE_PBS_CACHE_API_H 1
...
#define PACKAGE_STRING "torque 2.4.144"
...
#define PACKAGE_VERSION "2.4.144"

/* Define to the build date */
#define PBS_BUILD_DATE "Fri Sep 25 13:45:48 CEST 2015"

/* Define to the build directory */
#define PBS_BUILD_DIR "/home/simon/workspace/torque/_build_"

/* Define to the build hostname */
#define PBS_BUILD_HOST "thrain"

/* Define to the building username */
#define PBS_BUILD_USER "simon"

/* Define to the install directory */
#define PBS_CFLAGS "-std=gnu99 -pedantic -Wall -Wextra -ggdb3 -fno-lto -D_LARGEFILE64_SOURCE -W -Wall -Wextra -Wno-unused-parameter -Wno-long-long -pedantic"

/* Define to the install directory */
#define PBS_CONFIG_ARGS " '--with-debug' '--with-rcp=scp' '--enable-meta-fork' '--prefix=/usr' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--with-sendmail=/usr/sbin/sendmail' '--with-default-server=arien.ics.muni.cz' '--enable-syslog' '--enable-silent-rules' 'CXXFLAGS=-std=gnu++11 -pedantic -Wall -Wextra -ggdb3 -fno-lto' 'CFLAGS=-std=gnu99 -pedantic -Wall -Wextra -ggdb3 -fno-lto'"

/* Define to the name of the default PBS server */
#define PBS_DEFAULT_SERVER "arien.ics.muni.cz"

/* Define to the install directory */
#define PBS_INSTALL_DIR "/usr"

/* the PBS style machine type name */
#define PBS_MACH "linux"

/* Define to the source directory */
#define PBS_SOURCE_DIR "/home/simon/workspace/torque"
...
/* Define to enable Torque ports */
#define TORQUE_PORTS 1
